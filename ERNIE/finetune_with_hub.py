...
from finetune.classifier import create_model_with_hub, evaluate
...
def main(args):
    ...
    if args.do_train:
        ...
        with fluid.program_guard(train_program, startup_prog):
            with fluid.unique_name.guard():
                train_pyreader, graph_vars = create_model_with_hub(
                    args,
    ...
    if args.do_val or args.do_test:
        ...
        with fluid.program_guard(test_prog, startup_prog):
            with fluid.unique_name.guard():
                test_pyreader, graph_vars = create_model_with_hub(
                    args,
